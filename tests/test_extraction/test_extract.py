...
class TestHelper:
    ...
    def mock_read(self, mocker: MockerFixture):
        ...
        self.mocked_safe_load = mocker.patch(
            "extraction.extract.yaml.safe_load", return_value={"url": "test", 'defaults':{"test":'test'}, "parameter_mapping":{"test":'test'}}
        )
    ...
    def test_get_data_source_by_schema(self):
        ...
        self.mocked_data_source.assert_called_once_with('test_mock.com', default_param={"test": "test"}, parameter_mapping={})
